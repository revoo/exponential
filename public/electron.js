...
// const readData = (err, data) => {
    // if (!err) {
        // data5 = data;
        // console.log('read: ', data5);
        // emit event to front-end here to display data
    // } else {
        // console.error('ERROR: DB File not read!');
    // }
// };

// var data = flatDB.readFile(DATABASE_PATH, readData);
// returns a promise in a pending state.
